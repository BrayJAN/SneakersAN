...
<?php
function sendemail($mail_username,$mail_userpassword,$mail_setFromEmail,$mail_setFromName,$mail_addAddress,$txt_message,$mail_subject, $template, $pdfdoc, $nombret){
	...
	$mail->addStringAttachment($pdfdoc, $nombret);
